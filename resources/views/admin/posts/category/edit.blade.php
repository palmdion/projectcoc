...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">แก้ไขประเภทข่าวสาร</h1>
    </div>
    <div class="mb-2">
        <a href="{{route('category.index')}}" class="d-none d-sm-inline-block btn btn-sm btn-secondary   shadow-sm"> กลับ</a>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">แก้ไขประเภทข่าวสาร</h6>
        </div>
        <div class="card-body">
